                     ...
                     <div class="p-5">
                        ...
                        <form action="<?= route_to('register') ?>" method="post" class="user">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                 <input name="pass_confirm" type="password" class="form-control form-control-user <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php endif ?>" placeholder="<?= lang('Auth.repeatPassword') ?>" autocomplete="off">
                              </div>
                           </div>
